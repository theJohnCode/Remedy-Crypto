          ...
          <header class="header"> 
            ...
            <div class="container"> 
              <div class="header__row">
                ...
                </nav><a class="header__logo" href="/"><img src="{{ asset('storage/app/public/'.$settings->logo)}}" alt=""></a>
   ...
   <footer class="footer"> 
                  <div class="container"> 
                    ...
                    <div class="footer__bottom"> 
                       <p>© Copyright, <span >2018</span> {{$settings->site_name}}. All Rights Reserved</p>
                      <ul>
...
<div class="hamburger"><span class="bar"></span><span class="bar"></span><span class="bar"></span></div>
        ...
        <div class="mega-menu"> 
          <div class="container">
            <div class="mega-menu__top"> <a class="mega-menu__logo" href="/"><img src="{{ asset('storage/app/public/photos/'.$settings->logo)}}" alt=""></a>
            </div>

        ...
        <section class="intro auth-layout">
            <div class="container">
                <div class="intro__row">
                    <div class="intro__col"> <img class="intro__robot" src="temp/custom/assets/images/intro/robot.png"
            ...
            <div class="container container-large">
                <div class="section-intro">
                    ...
                    <div class="section-intro__description">
                        <p style="margin-top: -20px;">{{ $settings->site_name }} employees ensure that every investor in our
                            company can earn money</p>
                    </div>
                </div>
                <div class="deposits__block">
                                    ...
                                    <div class="deposits-item is-active" deposit="Starting">
                                        <div class="deposits-item__content">
                                            <div class="deposits-item__count"style="margin: 0;">
                                                <div class="deposits-item__count-number">{{ $plan->increment_amount }}
                                                </div>
                                            ...
                                            <div class="deposits-item__item">
                                                ...
                                                <p class="deposits-item__item-value">
                                                    {{ $settings->currency }}{{ $plan->min_price }} -
                                                    {{ $settings->currency }}{{ $plan->max_price }}
                                                </p>
                                            </div>
                                            <div class="deposits-item__item deposits-item__item--earn">
                        ...
                        <div class="deposits__col-sidebar">
                            <div class="limits-warning">
                                ...
                                <div class="limits-warning__content">
                                    <p>These commissions are charged by {{ $settings->site_name }} for the platform to work.
                                        They are not related to the profit received by our investors</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="typography">
                                    <ul>
                                        <li>
                                            ...
                                            <p><span class="color-primary">0.5%</span> from the received profit by the
                                                robot. This commission shows the earnings of the entire
                                                {{ $settings->site_name }} structure, namely, each employee.</p>
                                        </li>
                                        <li>
                                            <h4>ADMINISTRATIVE COMMISSION</h4>
                                            <p><span class="color-primary">0.5%</span> for technical support of the robot
                                                and the company as a whole. This commission includes the development and
                                                marketing costs of the company.</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="deposits__calculate">
                        <div class="calculate-profit"><a class="btn btn--line-primary js-open-calculate-form">
                                <span>Calculate Profit</span></a>
                            <form>
                                    ...
                                    <div class="calculate-profit__block-row">
                                        <div class="field">
                                            ...
                                            <div class="select-deposit">
                                                <div class="select-deposit__trigger">
                                                    <p class="select-deposit__value"><span
                                                            class="select-deposit__val">Starting</span> <strong><span
                                                                class="select-deposit__percent">1.8</span><sup>%</sup></strong>
                                                    </p>
                                                </div>
                                        ...
                                        <div class="field">
                                            ...
                                            <div class="field-group">
                                                <input class="field-gray field-counter" type="number" name="amount"
                                                    id="sum" value="100">
        ...
        <section class="funds">
            <div class="container">
                <div class="section-intro">
                    ...
                    <div class="section-intro__description">
                        <p>The best cryptocurrency developers works in our company. They have a wealth of experience and
                            understanding of the crypto market behind them. They brought {{ $settings->site_name }} to the
                            world level of development</p>
                    </div>
                </div>
                <div class="funds__slider swiper-container swiper-no-swiping js-swiper-funds">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="funds-item">
                                <div class="funds-item__icon"> <img src="temp/custom/assets/images/funds/1.png"
                                        alt="">
                                </div>
                                <h4 class="funds-item__title">UNIQUE TRADING BOT </h4>
                                <div class="funds-item__description">
                                    <p>{{ $settings->site_name }} team of professionals has created a unique trading robot
                                        that makes profit at any stage of the market: rise or fall</p>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="funds-item is-active">
                                <div class="funds-item__icon"> <img src="temp/custom/assets/images/funds/2.png"
                                        alt="">
                                </div>
                                <h4 class="funds-item__title">STABLE AND AUTOMATED INVESTMENT </h4>
                                <div class="funds-item__description">
                                    <p>The robot is not human-related. And that is why all investments are reliable and
                                        completely safe</p>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="funds-item">
                                <div class="funds-item__icon"> <img src="temp/custom/assets/images/funds/3.png"
                                        alt="">
                                </div>
                                <h4 class="funds-item__title">THE EXPERTS WILL DO EVERYTHING FOR YOU </h4>
                                <div class="funds-item__description">
                                    <p>The highly professional {{ $settings->site_name }} team controls all the processes
                                        of the trading robot around the clock. After investing, you will observe the growth
                                        of your capital in real time</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="company__row">
                        <div class="company__col">
                            <div class="certificate">
                                <div class="total-invested">
                                    ...
                                    <p class="total-invested__value"><?php echo date('z') + 2000; ?> </p>
                                </div>
                                <div class="participants">
                                    <p class="participants__title">Total Members:
                                    </p>
                                    <p class="participants__count">{{ $total_users + 89650 }} </p>
                                </div>
                                <ul class="totals">
                                    <li>
                                        <p class="totals__title">Total Invested </p>
                                        <p class="totals__value">{{ $total_deposits + 338400989 }} <sub>USD</sub>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="totals__title">Total Paid </p>
                                        <p class="totals__value">{{ $total_withdrawals + 101689885 }}<sub>USD</sub>
                                        </p>
                                    </li>
                        ...
                        <div class="company__col">
                            ...
                            <div class="typography">
                                ...
                                <p>{{ $settings->site_name }} is registered and has official permission for investment and
                                    trading activities. The services of our company are available to every investor from
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="steps-item">
                                ...
                                <div class="steps-item__description">
                                    <p>Click the Register button. Fill in your details to create a FREE
                                        {{ $settings->site_name }} account in seconds</p>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="steps-item">
                                ...
                                <div class="steps-item__description">
                                    <p>We offer a variety of investment plans to suit your financial goals. After reading,
                                        make a deposit</p>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="steps-item">
                                ...
                                <div class="steps-item__description">
                                    <p>After making a deposit, watch your capital grow by accumulating daily profit in real
                                        time</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="investment__row">
                    <div class="investment__col">
                        <div class="section-intro">
                            ...
                            <div class="section-intro__description">
                                <p>Anyone can take part in the affiliate program. It allows you to receive generous rewards
                                    by inviting new members</p>
                            </div>
                        </div>
                        <ul class="investment-stats">
                            <li>
                                ...
                                <div class="section-intro__description">
                                    <p>Get extra profit when people in your structure invite new investors to the company
                                    </p>
                                </div>
                            </li>
                            <li>
                    ...
                    <div class="investment__col"> <a class="notebook-video" href=""
                            data-fancybox="data-fancybox"> <span class="notebook-video__content"><span
                                    class="notebook-video__title">VIDEO PRESENTATION</span><span
                                    class="notebook-video__icon">
                                    <svg class="svg-icon">
                                        <use href="temp/custom/assets/icons/sprite.svg#icon-play"></use>
                                    </svg></span></span><img src="temp/custom/assets/images/investment/notebook.png"
                                alt=""></a>
                    </div>
                </div>
                ...
                <section class="payments"style="margin-bottom: 20px;">
                    <div class="container">
                        <div class="payments__row">
                            <div class="payments__col"> <img src="temp/custom/assets/images/payments/payment.png"
                                    alt="">
                            </div>
                            <div class="payments__col">
                                <div class="payments__content">
                                    ...
                                    <div class="typography">
                                        <p>Our company does not charge commissions for opening a deposit, as well as
                                            withdrawing funds from the platform</p>
                                    </div>
